...
public class updatedelete extends javax.swing.JFrame {
    ...
    try (MongoClient mongoClient = MongoClients.create(uri)) {
        ...
        // Define the filter to locate the book you want to update, e.g., based on the name
        Document filter = new Document("name", jTextField1.getText().toLowerCase());
        ...
        if (existingBook != null) {
            ...
            Document update = new Document("$set", new Document("author", jTextField2.getText().toLowerCase())
            ...
            // Book not found
            JOptionPane.showMessageDialog(this, "Book not available in the collection.");
        }
